 ...
 <section id="main_container">
	...
	<header id="header">
		<a href="<?php bloginfo("url");?>">
			<img class="logo" alt="logo" src="<?php bloginfo('template_directory'); ?>/images/logo.png">		
		</a>
		<img class="contact" alt="contact" src="<?php bloginfo('template_directory'); ?>/images/contact.png">
